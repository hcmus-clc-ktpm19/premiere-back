...
public class Constants {
  ...
  public static final String KEYCLOACK_TOKEN_URL = "http://localhost:8180/realms/premiere-realm/protocol/openid-connect/token";
  ...
  public static final String RECEIVER_BANK_NAME_IS_NOT_VALID = "The name of the receiver's bank is invalid";
